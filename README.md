...
車両購入の際に、直接ディーラーに行って話を聞くといくのは
少しハードルが高いと思っていらっしゃる方が多いと思います。
そんな方のために実際の利用者の生の評価が聞けるサイトがあればと思い、
このアプリを作成しました。
...
１回押すとマークに色がつきカウントが１上がり、
もう１回押すと色がなくなりいいねが取り消せます。
...
## レビュー検索機能
トップページにレビュー一覧からキーワード検索ボックスを配置予定
## ユーザー情報詳細表示機能
ユーザーの詳細情報を編集、表示できるようなページを作成予定。
自己紹介など
## GoogleMapを使った店舗検索機能
GoogleMapのAPIを導入し、ユーザー登録の際に入力した住所を参考に、
近隣のディーラー検索をする機能
## コメント投稿機能の非同期化
